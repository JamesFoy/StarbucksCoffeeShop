...
namespace WaterBuoyancy
{
    ...
    public class WaterFX : MonoBehaviour
    {
        ...
        [SerializeField] private WaterMode waterMode = WaterMode.Refractive;
        ...
        [SerializeField] private LayerMask refractLayers = -1;
        ...
        public void OnWillRenderObject()
        {
            ...
            m_HardwareWaterSupport = FindHardwareWaterSupport(renderer);
            ...
            if (mode >= WaterMode.Reflective)
            {
                ...
                CurrentRenderer.sharedMaterial.SetTexture("_ReflectionTex", m_ReflectionTexture);
            }
            ...
            if (mode >= WaterMode.Refractive)
            {
                ...
                CurrentRenderer.sharedMaterial.SetTexture("_RefractionTex", m_RefractionTexture);
            }
        ...
        WaterMode FindHardwareWaterSupport(Renderer renderer)
        {
            if (!renderer)
            {
